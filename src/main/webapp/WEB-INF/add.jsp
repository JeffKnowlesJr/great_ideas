		...
		<div id="wrapper">
			...
			<div id="dash-container">
				<div class="small-dash-container">
					<!-- CLASS CREATION FORM -->
					<form:form method="POST" action="/ideas" modelAttribute="idea" class="form-add-travel">
						<h5>Add Idea</h5>
						...
						<p><form:input path="name" class="input-field" placeholder="Put your idea here!"></form:input></p>
						...
						<input type="submit" value="Create" class="input-btn"/>
					</form:form>
				</div>
				<div id="bot-nav">
